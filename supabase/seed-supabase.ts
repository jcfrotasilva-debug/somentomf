 ...
 * Executa: DATABASE_URL="postgresql://..." npx tsx supabase/seed-supabase.ts
 */
...
async function seed() {
  ...
  console.log('');
  console.log('👤 Servidores (senha padrão: 123456):');
  console.log('   maria.silva@escola.sp.gov.br');
  console.log('   joao.pereira@escola.sp.gov.br');
  console.log('   ana.santos@escola.sp.gov.br');
  console.log('   pedro.oliveira@escola.sp.gov.br');
  console.log('   claudia.souza@escola.sp.gov.br');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n');
}
